...
DEFAULT_UPLOAD_DIR = "/app/data/uploads" if Path("/app").exists() else "uploads"
...
def get_service_description(service_data: object) -> str:
    if isinstance(service_data, dict):
        return str(service_data.get("description", ""))
    return str(service_data)


def get_service_photo(service_data: object) -> str:
    if isinstance(service_data, dict):
        return str(service_data.get("photo", ""))
    return ""


def make_service(description: str, photo: str = "") -> dict[str, str]:
    return {
